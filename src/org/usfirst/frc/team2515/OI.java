...
public class OI {
    ...
    public OI() {
        ...
        joystickOpenClawSlowButton.whileHeld(new openClaw(.3));
        joystickLiftBottomButton = new JoystickButton(joystick, 11);
        joystickLiftBottomButton.whenPressed(new autoLiftBottom(20));
        joystickLiftMiddleButton = new JoystickButton(joystick, 9);
        joystickLiftMiddleButton.whenPressed(new autoLiftMiddle(2400));
        joystickLiftTopButton = new JoystickButton(joystick, 7);
        joystickLiftTopButton.whenPressed(new autoLiftTop(4000));
        ...
        joystickOpenClawButton.whileHeld(new openClaw(1));
    ...
    // Determine drag from joystick toggle
